...
## V-Model
- 基於 Waterfall Model 的改進
- V 的左半邊
  - Requirement -> Design -> Architecture -> Module -> Implementation
- V 的右半邊
  - Unit Testing -> Integration Testing -> System Testing -> Acceptance Testing
  - 四個 testing 和左半邊的四個階段一一對應
- 強調開發和測試並行

## Sashimi Model
- 在大公司，不同 phase 常常有專人負責
- 前面瀑布式開發，會讓後面 phase 的人閒置
- 讓不同 phase 的人在某些時間點同時工作
- 可能會導致錯誤還有 redesign
...
- Phase
  ...
  - Elaboration
    - 細化階段
    - Deliverable
      - Software architecture plans & prototypes
  - Construction
    - 基於 elaboration 階段的基礎改進
    - 用多個 iteration 來完成
    - Deliverable
      - 持續改進軟體
  - Transition
